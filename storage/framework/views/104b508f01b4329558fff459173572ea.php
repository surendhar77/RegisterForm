...
unset($__errorArgs, $__bag); ?>" name="phone_number" value="<?php echo e($user->phone_number); ?>" required autocomplete="phone_number">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-check form-check-inline" >
                                ...
                                <input class="form-check-input" type="radio" name="gender" value="0"   <?php echo e($user->gender == 0 ? 'checked':''); ?>>
                                <label class="form-check-label" for="male">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="1"   <?php echo e($user->gender == 1 ? 'checked':''); ?>>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                              <textarea name="address" id="address" cols="30" rows="10"><?php echo e($user->address); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <img src="<?php echo e(asset('images/'.$user->image)); ?>" alt="picture ">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RegisterForm\resources\views/edit.blade.php ENDPATH**/ ?>